...
* **StatusNotifier System Tray**: Owns `org.kde.StatusNotifierWatcher` on the session DBus and renders StatusNotifierItem icons (nm-tray, CopyQ, Steam, etc.) with click support (Activate / SecondaryActivate / ContextMenu).
